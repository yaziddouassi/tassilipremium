...
class TassiliRouter extends Controller
{
   ...
   public function update(Request $request)
    ...
    $record =  \Tassili\Premium\Models\TassiliCrud::find($request->id);
...
if ($request->filled('panel')) {
     $panels = \Tassili\Premium\Models\TassiliCrud::where('panel',$request->panel)
             ->paginate(10) ;
}

if (!$request->filled('panel')) {
     $panels = \Tassili\Premium\Models\TassiliCrud::paginate(10) ;
}
    ...
    {  
        \Tassili\Premium\Models\TassiliCrud::where('id',$request->id)->update([
    ...
    {  
        \Tassili\Premium\Models\TassiliCrud::destroy($request->id);
    }  
    ...
    public function creator(Request $request)
    {
        ...
        foreach ($request->selected as $key => $value) {
            ...
            $crud = new \Tassili\Premium\Models\TassiliCrud() ;
