...
namespace  Tassili\Premium\Commands;

use Illuminate\Console\Command;
use App\Models\User; // Ensure you import the User model
use Illuminate\Support\Facades\Hash;
use Illuminate\Support\Facades\File;
use Tassili\Premium\Utils\TransformString;
use Tassili\Premium\Utils\WizardPart;
...
class WizardCommand extends Command
{
    ...
    public function handle()
    {
        ...
        File::copyDirectory(base_path('vendor/tassili/premium/Fichiers/WizardFiles'), $vueTarget);
